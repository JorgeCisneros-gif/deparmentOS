...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Cambiar mi contraseña (usuario autenticado)' }),
...
__decorate([
    (0, common_1.Get)('reset/validate'),
    (0, swagger_1.ApiOperation)({ summary: 'Validar token de reset (el frontend lo llama al cargar la página)' }),
...
__decorate([
    (0, common_1.Post)('reset/confirm'),
    (0, swagger_1.ApiOperation)({ summary: 'Aplicar nueva contraseña con el token de reset' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
